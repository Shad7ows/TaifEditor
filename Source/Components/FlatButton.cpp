...
void SPFlatButton::enterEvent(QEnterEvent *event) {
    QPushButton::enterEvent(event);
    startHoverAnimation(1.0);
}

void SPFlatButton::leaveEvent(QEvent *event) {
    QPushButton::leaveEvent(event);
    startHoverAnimation(0.0);
}

void SPFlatButton::paintEvent(QPaintEvent *event) {
    Q_UNUSED(event)
...
void SPFlatButton::startHoverAnimation(qreal targetValue) {
